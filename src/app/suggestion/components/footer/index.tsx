...
const Footer = () => {
  return (
    <>
      <div
        className="bg-blue-900 pb-3 font-extralight flex flex-col"
        id="a-propos-de-nous"
      >
            ...
            <div className="text-center items-center flex pt-10 md:pt-0">
              ...
              >
                <svg
                  ...
                  className="pr-3 text-5xl cursor-pointer font-extralight"
                  height="1em"
                  width="1em"
        ...
        <div className="container mx-auto text-slate-300 py-3">
          <div className="grid grid-cols-1 gap-10 p-3 md:grid-cols-3 md:p-0 items-center">
            <div className="presentation">
              <p className="mb-5">
                CHILLO est une société de conseil en nouvelles technologies.Nous
                concevons et developpons des applications
              </p>
              <p>
                Nous avons deux principales valeurs. Le bonheur de nos salariés
                est primordial; l’expérience client est notre centre d'intrêt.
              </p>
            </div>
            <div className="presentation">
              <p className="mb-5">
                CHILLO accélère la performance business et digitale des
                entreprises.{" "}
              </p>
              <p>
                De la stratégie opérationnelle à la mise en œuvre de solutions
                de pointe, drivées par les technologies web ou mobiles.
              </p>
            </div>
            <div className="presentation flex flex-col items-center justify-center">
              <div className="px-10 flex items-center justify-between text-center">
                <Link href="https://www.linkedin.com/company/chillo-tech">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
                ...
                <Link href="https://www.facebook.com/profile.php?id=100084306755977">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
                ...
                <Link target="_blank" href="https://wa.me/33761705745">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
