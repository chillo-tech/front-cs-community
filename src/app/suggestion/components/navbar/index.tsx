      ...
      {isDisplay ? (
        <>
          ...
          <div className="flex flex-col items-center top-0 right-0 left-0 bottom-0 bg-white  min-h-screen block">
            ...
            <button type="button" onClick={gotoHandler("/#notre-expertise")}>
              <span className="md:py-6 md:px-2 py-4 block text-gray-500 font-light text-lg hover:text-green-500 transition duration-300">
                Notre expertise
              </span>
            </button>
            <button
              type="button"
              onClick={gotoHandler("/#ils-nous-font-confiance")}
            >
              <span className="md:py-6 md:px-2 py-4 block text-gray-500 font-light text-lg hover:text-green-500 transition duration-300">
                Nos références
              </span>
            </button>
            <button type="button" onClick={gotoHandler("/coaching")}>
              <span className="md:py-6 md:px-2 py-4 block text-gray-500 font-light text-lg hover:text-green-500 transition duration-300">
                Coaching
              </span>
            </button>
            <button type="button" onClick={gotoHandler("/formations")}>
              <span className="md:py-6 md:px-2 py-4 block text-gray-500 font-light text-lg hover:text-green-500 transition duration-300">
                Nos formations
              </span>
            </button>
            <button type="button" onClick={gotoHandler("/nos-postes")}>
              <span className="md:py-6 md:px-2 py-4 block text-gray-500 font-light text-lg hover:text-green-500 transition duration-300">
                Rejoignez nous
              </span>
            </button>
            <button type="button" onClick={gotoHandler("/nous-contacter")}>
              <span className="md:py-6 md:px-2 py-4 block text-gray-500 font-light text-lg hover:text-green-500 transition duration-300">
                Contactez nous
              </span>
            </button>
