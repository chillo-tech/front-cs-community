...
function SuggestionEdit() {
  const { register, handleSuggestionSubmit, errors, submissionMessage, mutation } = useSuggestion();
        ...
        <div className="flex flex-col gap-2 font-light infos  py-3 rounded-mdd px-3 md:px-10 md:text-lg rounded-md text-slate-100">
          <p
            className={`mb-2 font-black text-2xl text-center mt-2 ${
              mutation.isSuccess ? 'text-blue-900' : 'text-rose-800 text-sm'
            }`}
          >
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              {...register('title')}
            />
            <p className="text-rose-800 text-sm">{errors?.title && 'Veuillez entrer un titre'}</p>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <select className="p-2 text-black rounded-md" {...register('author.tag')}>
          ...
          <div className="flex flex-col">
            ...
            />
            <p className="text-rose-800 text-sm">
              {errors && errors.author && errors.author.name && 'Veuillez nous indiquer notre nom.'}
            </p>
          </div>
